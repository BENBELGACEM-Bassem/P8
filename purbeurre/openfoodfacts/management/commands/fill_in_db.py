...
from ...apifetcher.configuration import ApiOff as api
from ...apifetcher import dbbuilder
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument('--category_list', type=list, help='Catgory names to be used')
        parser.add_argument('--category_size', type=int, help='Number of products per category')
	...
	def handle(self, *args, **options):
        try:
			...
			dbbuilder.build()
			self.stdout.write(self.style.SUCCESS('Data base successfully populated'))
